...
router.get("/get/mostPopular", async (req, res, next) => {
  // get mostPopular games by mostPopular
...
router.get("/get/topSeller", async (req, res, next) => {
  // get topSeller games by topSeller
...
router.get("/get/mostPlayed", async (req, res, next) => {
  // get mostPlayed games by mostPlayed
...
router.get("/:id/genres", async (req, res, next) => {
  // get all categories name by Genres of one game
  var id = req.params.id;
  var cat = [];
  try {
...
router.get("/genres/:id", async (req, res) => {
  // get all games of Category id (action)
