...
router.patch("/removeAllFromCart/:id", removeAllFromCart);
router.patch("/removeFromWishList/:id/:gameId", removeFromWishList);
router.patch("/updateUserDisplayName/:id", updateUserDisplayName);
router.patch("/updateUserEmail/:id", updateUserEmail);
